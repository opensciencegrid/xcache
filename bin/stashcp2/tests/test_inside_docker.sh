...
# Perform tests
python /StashCache/bin/stashcp2/stashcp.py -d /user/dweitzel/public/blast/queries/query1 ./
...
python /StashCache/bin/stashcp2/stashcp.py -d -r /user/dweitzel/public/blast/queries ./
ls -lah
